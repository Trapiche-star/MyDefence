...
namespace Sample
{
    public class ComponentTest: MonoBehaviour
    {
        ...
        {
            //[1] 플레이어 오브젝트
            //CompinentTest 스크립트가 붙어있는 게임오브젝트의 객채(인스턴스) 가져오기
            //CompinentTest 스크립트가 붙어있는 게임오브젝트의 다른 콤포넌트에 접근하기
            //this.transform
...
/* 게임오브젝트 (트랜스폼, 컴포넌트)의 인스턴스를 가져오는 방법
...
[1] 게임오브젝트(트랜스폼)의 인스턴스.GetCompinet<>()
